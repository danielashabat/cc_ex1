...
//
//		for (int i = 0; i < list->num_of_queues; i++) {
//			if (package->ID == ID) {
//				break;
//			}
...
//
//
//ListOfQueues* InitializeListOfQueues() {
//	ListOfQueues* list = NULL;
//	list = (ListOfQueues*)malloc(sizeof(ListOfQueues));
//	if (list == NULL) {
...
//	printf("[");
//
//	for (i = 0; i < list->num_of_queues; i++) {
//		printf("package ID: %d,\n ", package->ID );
//		package = package->next;
//	}
//	printf("]\n");
